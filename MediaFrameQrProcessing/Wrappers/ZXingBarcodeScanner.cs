namespace MediaFrameQrProcessing.Wrappers
{
    ...
    {
        private static BarcodeCaptureFrameProcessor frameProcessor;
        ...
        /// </param>
        public static async void ScanFirstCameraForBarcode(Action<string> resultCallback, TimeSpan? timeout)
        {
            string result = null;
            ...
            if (frameProcessor == null)
            {
                ...
                if (populated)
                {
                    ...
                    if (videoCaptureDevice != null)
                    {
                        ...
                        frameProcessor = new BarcodeCaptureFrameProcessor(mediaFrameSourceFinder, videoCaptureDevice, MediaEncodingSubtypes.Bgra8);
